...
# Out of the Maze class

def search_from(maze, start_row, start_column):
    global nb_calls
    nb_calls += 1
    print("search_from(maze, ",start_row,",",start_column,")")
    ...
    # in turn (if needed)
    # Default strategy: North, South, West, East
...
# Main Python program
os.chdir('/home/lamsadeuser/Bureau/Algorithmique_et_Programmation_2')
my_maze = Maze('maze0.txt')
my_maze.draw_maze()
my_maze.update_position(my_maze.start_row, my_maze.start_col)

search_from(my_maze, my_maze.start_row, my_maze.start_col)
print("Number of calls to search_from is", nb_calls)
